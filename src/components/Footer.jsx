          ...
          <div className="lg:col-span-2">
            ...
            <a href="#hero" className="flex items-center gap-3 mb-6 group w-fit">
              <div className="w-12 h-12 flex items-center justify-center overflow-hidden">
                <img src="/images/logo.png" alt="GG do Corte" className="w-full h-full object-contain" />
              </div>
            ...
            <p className="font-sans text-gray-500 text-sm leading-relaxed font-light max-w-xs mb-6">
              Onde o estilo começa. Uma experiência completa de cuidado masculino premium em Caponga, Cascavel — CE.
            </p>
